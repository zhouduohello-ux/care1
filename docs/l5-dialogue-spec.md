...
> **文档编号**：SPEC-L5-001  
> **版本**：v1.15  
> **分支**：`feat/l5-spec-pending-timeout-v2`  
> **对应架构层**：L5 Dialogue  
...
| 日期 | 版本 | 变更内容 | 作者 |
|---|---|---|---|---|
| 2026-07-11 | v1.15 | Turn Manager 文档补齐：新增 pending question 24h 静默超时流程说明，记录 `scan-expired-pending` scheduler job、超时 observation/state_updated Event 语义；补充 L5-FOLLOW-004/005 实现状态 | AI Agent |
